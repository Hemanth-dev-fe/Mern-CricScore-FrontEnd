  ...
  return (
    <Card sx={{ marginBottom: '8px', backgroundColor: '#f5f5f5', padding: '10x' }}>
      <CardContent>
        ...
        <Box sx={{ setDeliveryMapInEachOverplay: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
...
OverItem.propTypes = {
  ...
  runsInOver: PropTypes.number.isRequired,
  wicketsInOver: PropTypes.number.isRequired,
  over: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.string, PropTypes.number])).isRequired,
};
